...
static uint32_t Doom[] = {
    NOTE_DS, 3, NOTE_DS, 3, NOTE_DS, 4, NOTE_DS, 3, NOTE_DS, 3, NOTE_CS, 4, NOTE_DS, 3, NOTE_DS, 3, NOTE_B, 3, NOTE_DS, 3, NOTE_DS, 3, NOTE_A, 3,
    ...
    NOTE_DS, 3, NOTE_CS, 4, NOTE_DS, 3, NOTE_DS, 3, NOTE_B, 3, NOTE_DS, 3, NOTE_DS, 3, NOTE_A, 3,
    NOTE_DS, 3, NOTE_DS, 4, NOTE_DS, 3,
    NOTE_DS, 3, NOTE_CS, 4, NOTE_DS, 3, NOTE_DS, 3, NOTE_B, 3, NOTE_DS, 3, NOTE_DS, 3, NOTE_A, 3,

    NOTE_AS, 3, NOTE_B, 3, NOTE_DS, 3, NOTE_DS, 3, NOTE_DS, 4, NOTE_DS, 3,
    NOTE_DS, 3, NOTE_CS, 4, NOTE_DS, 3, NOTE_DS, 3, NOTE_B, 3, NOTE_DS, 3, NOTE_DS, 3, NOTE_A, 3,
    NOTE_DS, 3, NOTE_DS, 3, NOTE_DS, 4, NOTE_DS, 3, NOTE_DS, 3, NOTE_CS, 4, NOTE_DS, 3, NOTE_DS, 3,

    NOTE_B, 3, NOTE_DS, 3, NOTE_DS, 3, NOTE_A, 3, NOTE_DS, 3, NOTE_A, NOTE_DS, 3, NOTE_DS, 3, NOTE_AS, 3, NOTE_B, 3,
    NOTE_DS, 3, NOTE_DS, 3, NOTE_DS, 4, NOTE_DS, 3, NOTE_DS, 3, NOTE_CS, 4, NOTE_DS, 3, NOTE_DS, 3
